...
from .webapp_auth import router as webapp_auth_router
from .webapp_user import router as webapp_user_router
from .webapp_admin import router as webapp_admin_router
...
webapp_auth_api_route = APIRouter(prefix="/webapp/auth", tags=["Telegram WebApp 认证"])
webapp_user_api_route = APIRouter(prefix="/webapp/user", tags=["Telegram WebApp 用户接口"])
webapp_admin_api_route = APIRouter(prefix="/webapp/admin", tags=["Telegram WebApp 管理接口"])
...
webapp_auth_api_route.include_router(webapp_auth_router)
webapp_user_api_route.include_router(webapp_user_router)
webapp_admin_api_route.include_router(webapp_admin_router)
